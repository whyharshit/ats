...
os.environ["GOOGLE_API_KEY"] = os.getenv("GOOGLE_API_KEY")  # Replace this with your actual key

# Path to your Poppler bin folder (adjust it based on where your pdfinfo.exe is located)
